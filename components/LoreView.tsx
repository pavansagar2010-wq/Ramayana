...
const LoreView: React.FC<LoreViewProps> = ({ lore, isLoading, onGenerate }) => {
  if (isLoading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#FDFBF7] p-8">
        ...
        <p className="text-[#8D6E63] text-sm mt-2">Connecting with the divine chronicles.</p>
      </div>
    );
  }
  ...
  if (!lore) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center bg-[#FDFBF7] p-8 text-center">
        ...
        <h2 className="text-3xl font-serif-display text-[#5D4037] mb-4 uppercase tracking-widest">Universe Lore</h2>
        <p className="text-[#8D6E63] max-w-lg mb-8 text-lg">
          The foundation of the entire 20-volume series. Generate character sheets, location guides, and props blueprints to ensure consistency across the universe.
        </p>
        <button 
          onClick={onGenerate}
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <header className="text-center mb-16">
        ...
        <h1 className="text-5xl font-serif-display text-[#3E2723] uppercase tracking-widest">Universe Lore</h1>
